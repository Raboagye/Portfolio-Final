    ...
    <div 
     className=' flex-[1] md:flex-[0.9] mid:flex-[0.65] w-full pb-60 md:pb-80 relative perspective-1000 mt-28 mb-60 flex flex-col items-center mdium:items-start mdium:pl-16 lg:pl-0'>
          <div className='hidden group w-[350px] h-[350px] md:w-[400px] md:h-[400px] small:flex justify-center mdium:justify-start'>
              <div className='w-[125px] h-[125px] md:w-[250px]  md:h-[250px] transform-style-3d moveAnimate group mt-20 cursor-pointer' onClick={()=>openLink("https://www.richedin.richaboagye.com")}>
          ...
          className='w-[90%] mdium:w-[43%] top-80 md:top-48 flex flex-col items-center absolute mdium:right-0 pt-4 md:mt-64'>
              <p className='text-[20px] hover:text-white text-center pt-8 font-body text-sm md:text-sm lg:text-[1rem] cursor-pointer text-[#099D66] hover:underline-offset-8' onClick={()=>openLink("https://www.richedin.richaboagye.com")}>RichedIn: LinkedIn Clone</p>
              <div>
                  <p className='text-gray-400 dark:text-gray-500 transition-all duration-500 pt-8 font-body text-sm md:text-sm lg:text-[1rem]'>• Developed a comprehensive social networking web application resembling LinkedIn, utilizing cutting-edge technologies:</p>
                  <p className='text-gray-400 dark:text-gray-500 transition-all duration-500 pt-4 font-body text-sm md:text-sm lg:text-[1rem]'>• React | Redux Toolkit | Firebase | Material-UI</p>
                  <details className='details6 border-0 outline-none'><summary className='text-[#099D66] cursor-pointer mt-2 border-0 outline-none'>more</summary><p className='pt-4 font-body text-gray-400 dark:text-gray-500 transition-all duration-500 text-sm md:text-sm lg:text-[1rem]'>Seamlessly combined React, Redux Toolkit, Firebase, and Material-UI to create a dynamic networking platform, featuring enhanced state management, authentication, and visually appealing user interfaces.</p></details>
              </div>
